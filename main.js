const ageCalclate = () =>{
    ...
    const {years, months, days} = calculateAge(birthDetails,currentYear,currentMonth,currentMonth);
...
document.getElementById("calc-age-btn").addEventListener("click",ageCalclate);
